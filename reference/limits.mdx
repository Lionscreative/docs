...
- Publishing availability and published-project allowances depend on your plan
- Eligible plans can publish to a `kleap.io` subdomain
- Custom-domain access and allowances are listed on the pricing page

Publishing does not consume AI credits. Hosting availability and limits are plan-specific; see [pricing](https://kleap.co/pricing).
...
Published Kleap sites are static Astro sites served from Kleap's global edge network. Publishing is deliberate: click **Publish** or **Update** when you want a reviewed version to go live.
...
| Deployments | Plan-specific; started with Publish or Update |

Dynamic features — accounts, saved data, and forms — are handled by the built-in Kleap Database and KleapForm when you enable them. Plan-specific hosting and usage allowances are listed on [pricing](https://kleap.co/pricing).
