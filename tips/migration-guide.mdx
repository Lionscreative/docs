...
4. **Publish** — click Publish when you're ready to deploy to `https://your-app.kleap.io`
...
- One-click publishing when you decide the site is ready
...
5. **Publish** — click Publish to deploy to `your-app.kleap.io`
...
| **Deployment** | Netlify/Manual | Kleap Hosting from the Publish action |
...
5. **Publish** — click Publish when your site is ready
...
| **Hosting** | Manual | Kleap Hosting from the Publish action |
...
- **Email** - hello@kleap.co for complex migrations
