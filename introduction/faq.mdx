...
<AccordionGroup>
  <Accordion title="What can I build with Kleap?">
    You can create apps, internal tools, websites, logos, animations, and other digital projects. Web projects include:
    - Landing and marketing pages
    - Business and local-service sites
    - Portfolios and personal sites
    - Blogs and content sites
    - Pricing and product pages
    - Web apps and internal tools with logins and saved data (via Kleap Database)

    Generated web projects use Astro 5 with Tailwind CSS v4 and interactive React islands. For dynamic features (accounts, saved data) add the built-in Kleap Database; for payments use Stripe payment links.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="How do I share my site?">
    Once you click **Publish**, your site is live at `your-app.kleap.io` and you can share that link — visitors don't need to log in. Until you publish, the site exists only in your editor. After publishing, click **Update** whenever you want your latest changes to go live.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can I get a refund?">
    New subscription purchases may be refunded within 7 days if fewer than 20% of the included credits have been used. Consumed credits, renewals, domains, and one-off credit purchases are non-refundable. Contact hello@kleap.co.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="How many apps can I create?">
    App and publishing limits depend on your plan — see [kleap.co/pricing](https://kleap.co/pricing) for the current numbers.
  </Accordion>

  <Accordion title="Is deployment free?">
    Publishing costs no AI credits. Plan availability and published-app limits are listed on [kleap.co/pricing](https://kleap.co/pricing). Published web projects include SSL and delivery on Kleap's edge network.
  </Accordion>
