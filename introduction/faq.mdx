...
<AccordionGroup>
  <Accordion title="How many apps can I create?">
    Unlimited! There's no limit on the number of apps you can create on any plan.
  </Accordion>
  ...
  <Accordion title="Can I use my own domain?">
    Yes. Connect any domain you own. Kleap handles SSL certificates automatically. You can also purchase domains directly through Kleap.
  </Accordion>
