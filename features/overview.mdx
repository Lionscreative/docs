...
<CardGroup cols={2}>
  <Card title="Publishing" icon="rocket" href="/features/publishing">
    Deploy to production with one click. Go live in seconds.
  </Card>
...
| **AI-powered coding** | Describe features, AI builds them |
| **Kleap hosting** | Production hosting with global CDN |
